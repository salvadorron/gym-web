...
export default function MealPlan() {
  return (
    <div className=" bg-gray-900 text-gray-100 w-full max-w-4xl rounded-xl">
      <header className="bg-red-800 p-6 shadow-lg rounded-t-xl">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="bg-red-600 px-4 py-2 rounded-full text-white shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {planNutricional.comidas.map((comida, index) => (
            <div
              key={index}
              className="bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-red-500/20 transition-shadow duration-300"
            >
