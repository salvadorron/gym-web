        ...
        <TableBody>
          {members.map((member) => (
            <TableRow key={member.id}>
              ...
              <TableCell>
                <Badge data-role={member.roleId} className="data-[role=entrenador]:bg-blue-900 data-[role=entrenador]:text-white bg-white text-black hover:bg-white hover:text-black ">{member.roleId}</Badge>
              </TableCell>
              <TableCell>{member.age}</TableCell>
              {/* <TableCell>{member.city}</TableCell> */}
              {/* <TableCell>{member.speciality && <Badge className="text-white" variant="outline">{member.speciality}</Badge>}</TableCell> */}
              <TableCell>
