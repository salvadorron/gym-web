    ...
    return (
        <div className="flex flex-col items-center  justify-between gap-4 w-full bg-[#141218] shadow rounded-md p-4">
            ...
            <div className="flex items-center justify-between w-full hover:cursor-pointer " onClick={() => setOpenBox(!openBox)}>
                <h1 className="font-medium text-md text-nowrap text-white">{excersise.name}</h1>
                <div className="flex items-center justify-between pl-12 gap-4 ">
                    {excersise.repeats !== 0 && <h2 className="font-medium text-md text-nowrap text-white">{excersise.repeats} repeticiones</h2>}
                    {excersise.series !== 0 && <h2 className="font-medium text-md text-nowrap text-white">{excersise.series} series</h2>}
